...
# defining private subnet in AZ-a, priv_sub_3a
...
# Associate private subnet in AZ-a, priv_sub_3a with priv_rt
resource "aws_route_table_association" "priv_sub_3a_with_route_table_association" {
  subnet_id      = aws_subnet.priv_sub_3a.id
  route_table_id = aws_route_table.priv_rt.id
}

# Associate private subnet in AZ-b, priv_sub_4b with priv_rt
resource "aws_route_table_association" "priv_sub_4b_with_route_table_association" {
